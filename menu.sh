...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/YakkoXCode74/update/main/install_up.sh" && chmod +x /root/install_up.sh
sleep 2
./install_up.sh
sleep 5
rm /root/install_up.sh
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/bracoli/permission/main/version)
